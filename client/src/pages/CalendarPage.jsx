...
export default function CalendarPage(){
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-gray-300 p-4 bg-white text-black dark:border-gray-900 bg-white text-gray-900 placeholder:text-gray-400 border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white">
        <div className="text-sm text-gray-500 mb-2">Add Event</div>
        <div className="grid md:grid-cols-4 gap-2">
          <input value={title} onChange={e=>setTitle(e.target.value)} placeholder="Title"
            className="border border-gray-300 bg-white text-black rounded px-2 py-1 dark:border-gray-800 bg-white text-gray-900 placeholder:text-gray-400 border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white" />
